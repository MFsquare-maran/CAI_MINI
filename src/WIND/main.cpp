                   ...
                   float wind_speed_gust, float rain_gauge)
{
    ...
    if (logfile) {
        ...
        logfile.println(battery_voltage); logfile.print(",");
        logfile.println(wind_vane);       logfile.print(",");
        logfile.println(wind_speed_avg);  logfile.print(",");
        logfile.println(wind_speed_gust); logfile.print(",");
